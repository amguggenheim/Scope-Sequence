    ...
    majorStandards: [
      ...
      },
      {
        ...
        evidenceOutcomes: [
          ...
          'Draw evidence from literary or informational texts to support analysis, reflection, and research. (CCSS: W.9-10.9)',
          'Apply *grades 9-10 Reading standards to literature (for example: “Analyze how anauthor draws on and transforms source material in a specific work [for example: how Shakespeare treats a theme or topic from Ovid or the Bible or how a later author draws on a play by Shakespeare]”). (CCSS: W.9-10.9)',
    ...
    majorStandards: [
      {
        ...
        evidenceOutcomes: [
          ...
          'Work with peers to set rules for collegial discussions and decisionmaking (for example: informal consensus, taking votes on key issues, presentation of alternate views), clear goals and deadlines, and individual roles as needed. (CCSS: SL.9-10.1b)',
    ...
    majorStandards: [
      {
        ...
        evidenceOutcomes: [
          ...
          'Propel conversations by posing and responding to questions that relate the current discussion to broader themes or larger ideas; actively incorporate others into the discussion; and clarify, verify, or challenge ideas and conclusions. (CCSS: SL.9-10.1c)',
          'Respond thoughtfully to diverse perspectives, summarize points of agreement and disagreement, and, when warranted, qualify or justify their own views and understanding and make new connections in light of the evidence and reasoning presented. (CCSS: SL.9-10.1d)',
          'Integrate multiple sources of information presented in diverse media or formats (for example: visually, quantitatively, orally) evaluating the credibility and accuracy of each source. (CCSS: SL.9-10.2)'
        ],
      },
      {
        standard: 'Standard 1: Oral Expression and Listening',
    ...
    majorStandards: [
      ...
      },
      {
        ...
        evidenceOutcomes: [
          ...
          'Demonstrate command of the conventions of Standard English capitalization, punctuation, and spelling when writing. (CCSS: L.11-12.2)',
    ...
    majorStandards: [
      {
        ...
        evidenceOutcomes: [
          ...
          'Work with peers to promote civil, democratic discussions and decisionmaking, set clear goals and deadlines, and establish individual roles as needed. (CCSS: SL.11-12.1b)',
